...
class Application(object): 
    def __init__(self): 
        ...
        label1=Label(self.root, text ="Entrez la valeur de la résistance, en ohms :")
        label1.grid(row =2, column =1, columnspan =3) 
        button1=Button(self.root, text ='Montrer', command =self.changeCouleurs)
        button1.grid(row =3, column =1) 
        button2=Button(self.root, text ='Quitter', command =self.root.quit)
    ...
    #changer de couleur
      ...
      # Programme principal 
if __name__ == '__main__':              # logarithmes en base 10 
    f = Application()     